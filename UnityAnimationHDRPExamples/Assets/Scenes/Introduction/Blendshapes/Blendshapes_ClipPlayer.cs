...
[ConverterVersion("Blendshapes_ClipPlayer", 1)]
public class Blendshapes_ClipPlayer : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new Blendshapes_PlayClipComponent
        {
...
public struct Blendshapes_PlayClipComponent : IComponentData
{
    public BlobAssetReference<Clip> Clip;
}

public struct Blendshapes_PlayClipStateComponent : ISystemStateComponentData
{
...
public class Blendshapes_PlayClipSystem : SystemBase
{
    ...
    protected override void OnCreate()
    {
        ...
        {
            None = new ComponentType[] { typeof(Blendshapes_PlayClipComponent) },
            All = new ComponentType[] { typeof(Blendshapes_PlayClipStateComponent) }
        });
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .WithNone<Blendshapes_PlayClipStateComponent>()
            .WithoutBurst()
            .WithStructuralChanges()
            .ForEach((Entity e, ref Rig rig, ref Blendshapes_PlayClipComponent animation) =>
            {
        ...
        Entities
            ...
            .WithChangeFilter<Blendshapes_PlayClipComponent>()
            .WithoutBurst()
            .ForEach((Entity e, ref Blendshapes_PlayClipComponent animation, ref Blendshapes_PlayClipStateComponent state) =>
            {
        ...
        Entities
            ...
            .WithNone<Blendshapes_PlayClipComponent>()
            .WithoutBurst()
            .WithStructuralChanges()
            .ForEach((Entity e, ref Blendshapes_PlayClipStateComponent state) =>
            {
                m_GraphSystem.Dispose(state.Graph);
            }).Run();

        if (m_AnimationDataQuery.CalculateEntityCount() > 0)
            ecb.RemoveComponent(m_AnimationDataQuery, typeof(Blendshapes_PlayClipStateComponent));
    }
    ...
    static Blendshapes_PlayClipStateComponent CreateGraph(
        Entity entity,
        ProcessDefaultAnimationGraph graphSystem,
        ref Rig rig,
        ref Blendshapes_PlayClipComponent playClip
    )
    {
        GraphHandle graph = graphSystem.CreateGraph();
        var data = new Blendshapes_PlayClipStateComponent
        {
            Graph = graph,
