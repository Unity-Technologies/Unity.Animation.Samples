...
[ConverterVersion("RotatingCube_ClipPlayer", 1)]
public class RotatingCube_ClipPlayer : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new RotatingCube_PlayClipComponent
        {
...
public struct RotatingCube_PlayClipComponent : IComponentData
{
    public BlobAssetReference<Clip> Clip;
}

public struct RotatingCube_PlayClipStateComponent : ISystemStateComponentData
{
...
public class RotatingCube_PlayClipSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .WithNone<RotatingCube_PlayClipStateComponent>()
            .WithoutBurst()
            .WithStructuralChanges()
            .ForEach((Entity e, ref Rig rig, ref RotatingCube_PlayClipComponent animation) =>
            {
        ...
        Entities
            ...
            .WithChangeFilter<RotatingCube_PlayClipComponent>()
            .WithoutBurst()
            .ForEach((Entity e, ref RotatingCube_PlayClipComponent animation, ref RotatingCube_PlayClipStateComponent state) =>
            {
        ...
        Entities
            ...
            .WithNone<RotatingCube_PlayClipComponent>()
            .WithoutBurst()
            .WithStructuralChanges()
            .ForEach((Entity e, ref RotatingCube_PlayClipStateComponent state) =>
            {
                m_GraphSystem.Dispose(state.Graph);
            }).Run();

        if (m_AnimationDataQuery.CalculateEntityCount() > 0)
            ecb.RemoveComponent(m_AnimationDataQuery, typeof(RotatingCube_PlayClipStateComponent));
    }
