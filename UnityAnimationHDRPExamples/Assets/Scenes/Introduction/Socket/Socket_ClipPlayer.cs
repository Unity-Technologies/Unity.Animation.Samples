...
public class Socket_ClipPlayer : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new Socket_PlayClipComponent
        {
...
public struct Socket_PlayClipComponent : IComponentData
{
    public BlobAssetReference<Clip> Clip;
}

public struct Socket_PlayClipStateComponent : ISystemStateComponentData
{
...
public class Socket_PlayClipSystem : SystemBase
{
    ...
    protected override void OnCreate()
    {
        ...
        {
            None = new ComponentType[] { typeof(Socket_PlayClipComponent) },
            All = new ComponentType[] { typeof(Socket_PlayClipStateComponent) }
        });
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .WithNone<Socket_PlayClipStateComponent>()
            .WithoutBurst()
            .WithStructuralChanges()
            .ForEach((Entity e, ref Rig rig, ref Socket_PlayClipComponent animation) =>
            {
        ...
        Entities
            ...
            .WithChangeFilter<Socket_PlayClipComponent>()
            .WithoutBurst()
            .ForEach((Entity e, ref Socket_PlayClipComponent animation, ref Socket_PlayClipStateComponent state) =>
            {
        ...
        Entities
            ...
            .WithNone<Socket_PlayClipComponent>()
            .WithoutBurst()
            .WithStructuralChanges()
            .ForEach((Entity e, ref Socket_PlayClipStateComponent state) =>
            {
                m_GraphSystem.Dispose(state.Graph);
            }).Run();

        if (m_AnimationDataQuery.CalculateEntityCount() > 0)
            ecb.RemoveComponent(m_AnimationDataQuery, typeof(Socket_PlayClipStateComponent));
    }
