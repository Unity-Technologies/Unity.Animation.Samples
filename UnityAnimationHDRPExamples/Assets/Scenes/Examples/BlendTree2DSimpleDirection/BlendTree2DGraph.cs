...
public class BlendTree2DGraphSystem : SampleSystemBase<
    ...
    >
{
    protected override BlendTree2DData CreateGraph(Entity entity, ref Rig rig, PreAnimationGraphSystem graphSystem, ref BlendTree2DSetup setup)
    {
        ...
        set.Connect(data.BlendTreeNode, BlendTree2DNode.KernelPorts.Output, data.EntityNode);
    ...
    protected override void DestroyGraph(Entity entity, PreAnimationGraphSystem graphSystem, ref BlendTree2DData data)
    {
        var set = graphSystem.Set;
...
public class ExtractBlendTree2DParametersNode
    : NodeDefinition<ExtractBlendTree2DParametersNode.Data, ExtractBlendTree2DParametersNode.SimPorts, ExtractBlendTree2DParametersNode.KernelData, ExtractBlendTree2DParametersNode.KernelDefs, ExtractBlendTree2DParametersNode.Kernel>
{
